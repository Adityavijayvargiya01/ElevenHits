...
export default function Navbar() {
  return (
    ...
    <div>
    <ul className='flex text-lg font-medium gap-12 px-7 py-2 rounded-xl bg-primary text-accent'>
      <a href="/">Home</a>
    ...
    <Button className='bg-accent-foreground text-accent px-4 py-2 rounded-xl font-medium'>Cart <ShoppingCartIcon className='h-6 w-6 m-1'/></Button>
    </div>
